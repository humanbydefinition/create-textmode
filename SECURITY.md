...
`create-textmode` is actively maintained on its supported release channels.
...
- The `create-textmode` version, Node.js runtime, package manager, operating system, and
  integration details
...
`create-textmode` follows coordinated disclosure.
...
- Official npm releases published for `create-textmode`
